...
if((isset( $_SESSION["ID"])) && (isset($_SESSION["USERTYPE"])) && (isset($_SESSION["ID_DEPT"])) && $_SESSION["USERTYPE"]=="staff"){
  ?> 
<!DOCTYPE html>
<html>
             ...
             <div><?php
               ...
               <?php echo $_SESSION["MSG"];?></h2>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="5" coloums="10" placeholder="Type here" name="description"></textarea>
                </div>
                <div class="send-btn">
