<?php session_start();
 class dboperations{
    ...
    function loginAuth($username,$password){
        $query="select id,name,usertype,id_dept from tb_login1 where username=:username and password=:password";
    ...
    function staffoperations($operation,$id=null,$name=null,$phone=null,$email=null,$username=null,$password=null,$id_dept=null){
     ...
     function dept_opretions($operation,$dept_id=null,$dname=null){
        switch($operation){
            case "insert":
                 ...
                 $query="insert into tb_dept(dname)
                 values(:dname)";
                 $stmt=$this->con->prepare($query);
     ...
     function noticeoperation($operation,$id=null,$staff_id=null,$title=null,$type_id=null,$usertype=null,$date=null,$description=null,$id_dept=null){
        switch($operation){
            case "insert":
                 $query="insert into tb_notice(id,title,type_id,usertype,date,description,id_dept,staff_id)
                  values(:id,:staff_id,:title,:type_id,:usertype,:date,:description,:id_dept)";
                 $stmt=$this->con->prepare($query);
                 $stmt->bindParam(":id",$id);
      ...
      function getstudNotice($department_id){
        $query="select id,title,description,id_dept from tb_notice where id_dept=:id_dept";
        $stmt=$this->con->prepare($query);
        $stmt->bindParam(":id_dept",$department_id);
        $stmt->execute();
