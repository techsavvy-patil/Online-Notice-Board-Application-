        ...
        <div class="row">
          <div class="col-lg-12"> 
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-file-text-o"></i>View Notice</li>
            </ol>
          </div>
        </div>
        <div class="row">
              ...
              <table class="table table-striped table-advance table-hover">
                <thead class="thead-light">
                  ...
                  <thead class="thead-light">
                    ...
                    <th><i class="icon_phone"></i> DESCRIPTION</th>
                    <th><i class="icon_mail_alt"></i> ID_DEPT</th>
                    <th><i class="icon_key_alt"></i> EDIT</th>
