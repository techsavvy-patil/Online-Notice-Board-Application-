...
if((isset( $_SESSION["ID"])) && (isset($_SESSION["USERTYPE"])) && (isset($_SESSION["ID_DEPT"])) ){
  ?> 
<!DOCTYPE html>
<html>
...
<body>
      ...
      <div class="row mar-bot40">
        <div class="col-md-offset-3 col-md-6">
          <div class="section-header">
            <h2 class="section-heading animated" data-animation="bounceInUp">SEND NOTICE</h2>
             ...
             <div><?php
               ...
               <?php echo $_SESSION["MSG"];?></h2>
                ...
                ?>
                 ...
                 <form method="post" action="wnotice.php">
                  ...
                  <div class="col-md-offset-3 col-md-6">
                    <P><label for="comment">USERS:</label>
              ...
              <div class="col-md-offset-3 col-md-6">
             <input type="text" required rows="5" name="title" placeholder="Title">
               </div>
              <div class="col-md-offset-2  col-md-6">
              <label for="comment">DATE:</label><br>
              </div>
              <div class="col-md-offset-3  col-md-6">
             <input type="text" required rows="5" name="date" placeholder="Date">
             </div>
             <div class="col-md-offset-2  col-md-6">
            <label for="comment">Description:</label>
              </div>
            <textarea class="form-control" required rows="5" coloums="10" placeholder="Type here" name="description"></textarea>
            </div>
                <div class="send-btn">
  ...
  foreach($notices as $notice){
    ...
    <td><?php echo $notice["id_dept"];?></td>
    <td><form method="POST" action="wnotice.php">
        <input type="hidden" name="operation" value="update"/>
        <input type="hidden" name="id" value="<?php echo $notice["id"];?>"/>
        <input type="hidden" name="title" value="<?php echo $notice["title"];?>"/>
        <input type="hidden" name="description" value="<?php echo $notice["description"];?>"/>
